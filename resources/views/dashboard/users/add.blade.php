                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    {!! Form::open(['route' => 'users.store','files' => true,'class' => 'j-pro','id' => 'j-pro'])!!}
                                            ...
                                            <div class="j-content">
                                                ...
                                                {!! Form::label('role', "User Role",['class'=>'j-input']) !!}
                                                    <div class="j-input">
                                                        ...
                                                        {!! Form::select('role',$roles,null, ['class' => '','placeholder' => "Select", 'style'=>'width: 100%;','tabindex'=>'-1','aria-hidden'=>'true','required' => '1'])!!}
                                                        @if(count($errors)>0)
                                                            @if($errors->has('role'))
...
<script>
$('input:password') .addClass( "form-control form-control-success" );



$("#first_name").focusout(function(){
				var data= $("#first_name").val()+" "+$("#middle_name").val()+" "+$("#last_name").val();
				$("#full_name").val(data);
