                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="card-body">
	                           <table id="table4" data-toolbar="#toolbar" data-search="false" data-show-refresh="false"
	                                ...
	                                <thead>
	                                <tr>
	                                    <th data-field="Role Name" data-sortable="false">Role Name</th>
                                    ...
                                    @foreach($TableData as $item)
                                      <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('roles.edit',$item->id)}}" style="color: #fff;" class=" btn  btn-info"
                                            >
...
<script type="text/javascript">
 ...
 $('.fixed-table-toolbar').append(`{!! Form::open(['route' => 'roles.search','method'=>'GET','class' => 'float-left','style' => 'width: calc(100% - 155px);margin-top: 13px;'])!!}
