                            ...
                            <div class="card-body">
                                ...
                                <div class="master-search">
                                        ...
                                        <div class="form-row align-items-center">
                                           ...
                                           <form action="{{route('searchWish')}}" method="GET" >
                                         
                                            <div class="col-auto my-1">
                                                <input class="form-control mr-sm-2 custom-search" type="search" name="query" value="@if(isset($q)){{$q}}@endif" placeholder="Custom Search" aria-label="Search" required><br>
...
<script type="text/javascript">
    $( document ).ready(function() {
           $('#sortBy').change(function(){
              var value = $(this).val();
              if(value=='Sort By'){
var url='http://localhost:8000/wish-list';
        window.location.href = url;
              }
              else{
                var url='http://localhost:8000/wish-list/sortby/'+value;
        window.location.href = url;
              }
